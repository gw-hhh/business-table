...
export default defineConfig({
  ...
  projects: [
    ...
    { name: 'chromium-preview', testMatch: ['demo.spec.ts','configuration.spec.ts','visual-parity.spec.ts','text-style.spec.ts','settings-refinement.spec.ts','filter-migration.spec.ts','search-runtime.spec.ts','toolbar-settings.spec.ts'], use: { baseURL: 'http://127.0.0.1:4174' } }
  ],
  webServer: [
