...
const props = withDefaults(defineProps<{ title: string; subtitle?: string; wide?: boolean; busy?: boolean }>(), { busy: false })
...
<template>
  <Teleport to="body">
    <div class="bt-dialog-overlay" @pointerdown.self="close">
      <section ref="dialog" class="bt-dialog" :class="{ 'bt-dialog--wide': wide }" role="dialog" aria-modal="true" :aria-label="title" tabindex="-1" @keydown="keydown">
