...
<template>
  <div class="bt-settings-page">
    <section class="bt-settings-section"><h4>默认文字</h4>
    ...
    <section class="bt-settings-section"><h4>布局</h4>
      <div class="bt-settings-grid bt-settings-grid--three">
    ...
    <section class="bt-settings-section"><h4>设置备份</h4><p class="bt-settings-note">只包含列、排序、按钮和外观设置，不包含业务数据。恢复后仍需点击应用。</p><div class="bt-settings-inline"><button class="bt-ui-button" type="button" @click="emit('backup')"><TableIcon name="download" :size="14" />导出设置</button><button class="bt-ui-button" type="button" @click="emit('restore')"><TableIcon name="upload" :size="14" />恢复设置</button></div></section>
  </div>
</template>
