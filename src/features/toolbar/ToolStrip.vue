...
const props = withDefaults(defineProps<{
  ...
  menuClass?: string
}>(), { layout: () => ({}), gap: 4, moreLabel: '更多工具', buttonClass: '', iconButtonClass: '', menuClass: '' })
...
const inOverflow = (tool: ToolDefinition) => tool.position === 'more' || (narrow.value && !tool.fixed)
...
<template>
  <div v-if="presented.length" ref="root" class="bt-tool-strip" :style="{ gap: `${gap}px` }">
