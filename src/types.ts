...
export interface ColumnTextStyle{fontFamily?:'inherit'|'sans-serif'|'serif'|'monospace';fontSize?:number;fontWeight?:'normal'|'500'|'600'|'bold';color?:string;align?:'left'|'center'|'right'}
...
export interface UserColumnConfig{title?:string;visible?:boolean;order?:number;width?:number;fixed?:FixedSide;align?:'left'|'center'|'right';sortable?:boolean;headerStyle?:ColumnTextStyle;cellStyle?:ColumnTextStyle}
